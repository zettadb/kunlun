...
--/home/kunlun/pgregressdata
-- COPY
--/home/kunlun/pgregressdata/results
...
COPY slow_emp4000 FROM '/home/kunlun/pgregressdata/rect.data';

COPY person FROM '/home/kunlun/pgregressdata/person.data';

COPY emp FROM '/home/kunlun/pgregressdata/emp.data';

COPY student FROM '/home/kunlun/pgregressdata/student.data';

COPY stud_emp FROM '/home/kunlun/pgregressdata/stud_emp.data';


CREATE temp TABLE road (name	text,thepath 	path);
COPY road FROM '/home/kunlun/pgregressdata/streets.data';
...
COPY real_city FROM '/home/kunlun/pgregressdata/real_city.data';


COPY hash_i4_heap FROM '/home/kunlun/pgregressdata/hash.data';

COPY hash_name_heap FROM '/home/kunlun/pgregressdata/hash.data';

COPY hash_txt_heap FROM '/home/kunlun/pgregressdata/hash.data';

COPY hash_f8_heap FROM '/home/kunlun/pgregressdata/hash.data';


CREATE temp TABLE IF NOT EXISTS test_tsvector(t text,a tsvector);
COPY test_tsvector FROM '/home/kunlun/pgregressdata/tsearch.data';


COPY testjsonb FROM '/home/kunlun/pgregressdata/jsonb.data';
...
--
-- COPY hash_ovfl_heap FROM '/home/kunlun/pgregressdata/hashovfl.data';

COPY bt_i4_heap FROM '/home/kunlun/pgregressdata/desc.data';

COPY bt_name_heap FROM '/home/kunlun/pgregressdata/hash.data';

COPY bt_txt_heap FROM '/home/kunlun/pgregressdata/desc.data';

COPY bt_f8_heap FROM '/home/kunlun/pgregressdata/hash.data';
...
COPY array_op_test FROM '/home/kunlun/pgregressdata/array.data';
...
COPY array_index_op_test FROM '/home/kunlun/pgregressdata/array.data';
