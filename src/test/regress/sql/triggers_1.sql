...
create table trigtest (f1 int primary key, f2 text);
...
CREATE TABLE some_t (some_col boolean primary key);
...
CREATE TABLE trigger_test (f1 int primary key, f2 text, f3 text);
...
create table parent (a text primary KEY, b int) partition by list (a);
