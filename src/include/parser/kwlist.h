...
PG_KEYWORD("auto_increment", AUTO_INCREMENT, RESERVED_KEYWORD)
...
PG_KEYWORD("nocache", NOCACHE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("noorder", NOORDER, UNRESERVED_KEYWORD)
...
PG_KEYWORD("persist", PERSIST, UNRESERVED_KEYWORD)
PG_KEYWORD("persist_only", PERSIST_ONLY, UNRESERVED_KEYWORD)
...
PG_KEYWORD("shard", SHARD, UNRESERVED_KEYWORD)
...
PG_KEYWORD("variables", VARIABLES, TYPE_FUNC_NAME_KEYWORD)
